...
int enesimoElementoDaSerie(int num)
{
	int i, soma = 0;
	
	for (i = 0; i <= num; i++) // i <= num na ultima interação, pq ele precisa ser somado também.
	//soma é parecido com i, é ele quem vai nos dar o valor da serie
	// Tenta reescrever o codigo pra fixar
	{
		soma += i;
	}
...
{
	printf("%d", enesimoElementoDaSerie(4));
