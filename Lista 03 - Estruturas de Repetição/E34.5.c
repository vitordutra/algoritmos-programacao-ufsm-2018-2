...
{
	int canal, np;
	float total2 = 0, total4 = 0, total5 = 0, total9 = 0, total = 0; 
	...
	printf("A audiencia do canal 2 e de %f pct\n", aud2);
	printf("A audiencia do canal 4 e de %f pct\n", aud4);
	printf("A audiencia do canal 5 e de %f pct\n", aud5);
	printf("A audiencia do canal 9 e de %f pct\n", aud9);	
