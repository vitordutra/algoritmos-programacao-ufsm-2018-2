...
int main(int argc, char *argv[]) 
{
	...
	float peso, altura, soma, idade_media, maior_altura = 0.0, maior_peso = 0.0;
	...
	printf("A media de idade dos atletas: %f", media_idade);
	printf("O atleta masculino #%i tem a maior altura, com %.2f m",  id_maior_altura, maior_altura);
	printf("A atleta feminina #%i tem o maior peso, com %.2f kg", id_maior_peso, maior_peso);
